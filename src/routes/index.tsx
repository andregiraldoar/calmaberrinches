...
function Index() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Total en bonos y extras antes del vistazo al contenido */}
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-5 text-center">
          <div className="mx-auto inline-flex flex-col items-center gap-2 rounded-full border border-lavender/60 bg-lavender/40 px-8 py-4">
            ...
            <span className="flex flex-wrap items-baseline justify-center gap-x-3 gap-y-1">
              <span className="text-lg font-bold text-muted-foreground line-through">$13.99 USD</span>
              <span className="font-display text-2xl font-extrabold text-coral-foreground">$0.00 para ti</span>
            </span>
          </div>
          <div className="mt-6">
            <Cta>Quiero la guía + 7 bonos + 3 extras →</Cta>
          </div>
        </div>
      </section>
